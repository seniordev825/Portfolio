  ...
  return (
    <div className="relative z-10">
      <SectionHeader
        ...
        description={
          <div>
            I&apos;m a <span className="text-about_me_green">Full stack python developer</span> specialized on <span className="text-about_me_green">Web Applications</span>
          </div>
        }
      />
      <Stars id="about-me" />
      <div className="@container">
        <div className="flex flex-col gap-8 mt-24 @lg:flex-row justify-between">
          <div className="max-w-xl flex-auto">
            <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">Tan Kai De</h3>
            ...
            <p className="mt-4 text-lg text-gray-500">For 5 years in this industry I have worked with multiple front-end and back-end(Django) technologies.</p>
            <p className="mt-4 text-lg text-gray-500">I know AI/ML.</p>
          </div>
                ...
                <div className="border-y py-2 border-gray-500/30 mb-6">
                  <div className="flex flex-wrap gap-x-6">
                    <div className="text-lg font-bold leading-9 tracking-tight flex gap-1">
                      <p className="text-white">Malay</p> - <p className="text-gray-500">Native</p>
                    </div>
                    <div className="text-lg font-bold leading-9 tracking-tight flex gap-1">
              ...
              <GlowCard className="hover:shadow-about_me_green/90" glowClassName="from-[#6bc072] to-[#6bc072]">
                <div className="flex flex-col gap-8 @lg:flex-row justify-between">
                  ...
                  <div className="max-w-xl flex-auto">
                    ...
                    <p className="text-base leading-7 text-about_me_green">National University of Singapore</p>
                  </div>
                </div>
              </GlowCard>
            </FadeIn>
