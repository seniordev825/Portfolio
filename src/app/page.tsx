...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Mid Engineer</span> with <span className="text-work_experience_orange">5+ years</span> of experience in the software industry
        </div>
      ),
    },
          ...
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              <h1 className="font-display text-5xl font-medium tracking-tight [text-wrap:balance] sm:text-6xl">
                Tan Kai De<span className="wave">👋</span>
              </h1>
              ...
              <p className="max-w-3xl">Software engineer with a B.S. in Computer Science and Technology with experience in Front-End and Back-End technologies.</p>
            </FadeIn>
